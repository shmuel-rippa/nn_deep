...
class KNearestNeighbor:
  ...
  def compute_distances_two_loops(self, X):
    ...
    print len(X[0,:]),len(self.X_train[0,:])
  ...
  def compute_distances_no_loops(self, X):
    ...
    x_sqr.shape       = (num_test,-1)
    x_train_sqr.shape = (-1,num_train)
    dists             = np.sqrt(x_sqr + x_train_sqr - 2.*X.dot(self.X_train.T))
    return dists
  ...
  def predict_labels(self, dists, k=1):
    ...
    for i in xrange(num_test):
      ...
      #########################################################################
      sorted_row_indx = np.argsort(dists[i,:]) 
      closest_y       = self.y_train[sorted_row_indx[:k]]
      #########################################################################
      # TODO:                                                                 #
